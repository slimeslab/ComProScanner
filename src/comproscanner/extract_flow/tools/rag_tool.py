...
class RAGTool(BaseTool):
    ...
    def _get_llm(self) -> BaseChatModel:
        ...
        if model.startswith(("gpt-", "text-", "o1", "o3")):
            ...
            return ChatOpenAI(model_name=model, request_timeout=1000, **common_params)
        ...
        # Anthropic Claude models
            ...
            return ChatAnthropic(model_name=model, **common_params)
        ...
        # Fireworks models
            ...
            return ChatFireworks(
                model_name=model, request_timeout=1000, **common_params
            )
    ...
    def _run(self, doi: str, query: str) -> str:
        """Execute the RAG tool with the given DOI and query

        Args:
            doi (str): The DOI of the document to be used for answering the query.
            query (str): The query to be answered using the RAG system.
