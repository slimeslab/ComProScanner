...
class DefaultPaths:
    ...
    FAILED_AUTOMATED_ARTICLES_FILENAME = "results/article_processor_failed_articles.txt"
    ...
    def __init__(self, main_property_keyword):
        ...
        self.PDF_PROCESSED_DOIS_FILENAME = (
            f"logs/{main_property_keyword}_pdf_processed_dois.txt"
        )
